...
<div class="card-body">
<fieldset >
    <input class="form-control" type="text" placeholder="Default input" data-comp-titulo>
    <br>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" data-comp-descricao></textarea>
    <br>
    </fieldset>
